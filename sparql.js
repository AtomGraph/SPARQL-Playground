...
async function query() {
	...
	var result = await engine.query(queryString, { "sources": sources });
	const resultsDiv = document.getElementById("results");
	const outputMediaType = document.getElementById("output-media-type").value;
	const { data } = await engine.resultToString(result, outputMediaType);
	...
	result = await engine.query(queryString, { "sources": sources });
